                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li>
                                <a href="#">
                                    ...
                                    <div>Indicisplina Injustificada.
                                        <br />
                                        <span class="label label-primary">Importante</span> 
                            ...
                            <li>
                                <a href="#">
                                    <div>
                                        <strong>Profesor Jonson</strong>
                                        <span class="pull-right text-muted">
                                            <em>Yesterday</em>
                                        </span>
                                    </div>
                                    <div>Tarea RM enviada.
                                         <br />
                                        <span class="label label-success"> Moderada </span> 
                                    </div>
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a href="#">
                                    <div>
                                        <strong>Profesor Henry</strong>
                                        <span class="pull-right text-muted">
                                            <em>26 Jan 2014</em>
                                        </span>
                                    </div>
                                    <div>Tarea MATEMATICA enviada.
                                         <br />
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel active">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle collapsed" data-target="#form-nav">
                        <i class="icon-pencil"></i> Usuarios
                    ...
                    <ul class="in" id="form-nav">
                        <li class=""><a href="forms_general.html"><i class="icon-angle-right"></i> Gestionar Usuarios </a></li>
                        <li class=""><a href="forms_advance.html"><i class="icon-angle-right"></i> Registrar Usuarios </a></li>
                    </ul>
                </li>
